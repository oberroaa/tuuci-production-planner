...
import { Camera, Printer, CheckCircle, RefreshCw, Layers, Scissors, QrCode, AlertTriangle, Search, Check, AlertCircle } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            {printedLabels.length > 0 && (
              <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-blue-100 text-blue-800">
                {printedLabels.length} ETIQUETAS LISTAS
              </span>
            )}
          </div>
                  ...
                  <div className="flex items-center space-x-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-[11px] text-slate-600 mt-0.5">
                        Rango correlativo: <strong className="text-blue-600 font-bold">Pieza 1 a {printedLabels.length}</strong> (Total {printedLabels.length} sombrillas)
                      </div>
                    </div>
                  </div>
