          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900 flex items-center space-x-2">
                <span>Mover / Regresar Pieza</span>
                <span className="font-mono text-xs px-2 py-0.5 rounded bg-blue-100 text-blue-800 font-extrabold">
                  {piece.codigo_qr_unico}
                </span>
              </h2>
              <p className="text-xs text-slate-500">
                Ajuste operativo o reproceso por defecto/error anterior
              </p>
            </div>
          </div>
          <button
